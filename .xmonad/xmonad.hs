...
myLayout = avoidStruts $ boringWindows $ smartBorders (
            renamed [Replace "Tiled"]     (  myGaps . minimize $ tiled ) 
        ||| renamed [Replace "Three"]     (  myGaps . minimize $ ThreeColMid 1 (3/100) (1/2) )
        ||| renamed [Replace "Grid"]      (  myGaps . minimize $ Grid )
        ||| renamed [Replace "Cols"]      (  myGaps . minimize $ multiCol [1] 1 0.01 (-0.5) )
        ||| renamed [Replace "Full"]      (  minimize $ Full )
        ||| renamed [Replace "Float"]     (  minimize $ simplestFloat )
       )
        where
